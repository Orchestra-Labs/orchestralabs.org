...
export const GenesisDelegation = () => (
  <div className="mt-[84px] lg:mt-[104px] mb-0 bg-background-dark-grey flex flex-col md:flex-row">
    <PageNavigator />
    <div className="page-container my-0 flex flex-col-reverse md:flex-row pt-[26px] gap-5 lg:gap-10 xl:gap-15 pl-25px md:pl-12 xl:pl-17">
      <div className="my-0 pt-6 pt-8 lg:pt-11 pb-9 md:pb-14 xl:pb-19 text-body-md text-grey">
        <h1 className="text-white font-semibold text-h2 md:text-h1 xl:text-display2">
          Orchestra Labs Genesis Delegation Program
        </h1>
        <p className="mt-10">
          The Genesis Delegation Program is one of the programs through which
          Orchestra Labs delegates stakes to mainnet validators. The program
          will delegate stakes to validators for a four-month period starting
          from the coin launch. Changes in delegation might occur in special
          circumstances, such as poor validator performance.
        </p>
        <p className="mt-5">
        ...
        <div id={HEADINGS[1].id} className="mt-15">
          ...
          <p className="mt-5">
            30 validators will be selected to receive delegations at mainnet
            launch. Validators are divided into two performance-based buckets:
          </p>
          <ul className="mt-5">
            <li className="mb-4">
              <p className="ml-5">
                - <strong>Bucket 1:</strong> 12 validators with 2x the
                delegation of Bucket 2
              </p>
            </li>
            <li className="mb-4">
              <p className="ml-5">
          ...
          <p className="mt-5">
            Existing validators with current delegations will not lose their
            stakes but may receive additional coins if eligible.
          </p>
        </div>
