...
import soundWaveIcon from './../assets/images/sound-wave.png';
        ...
        <div className="navbar-container">
            <div className="navbar">
                ...
                <div id="navlinks">
                    ...
                    <Link to={NavOptions.DEMO} className={isActive([NavOptions.INTERACTIVE_DEMO, NavOptions.DEMO, NavOptions.CHART])}>View Demo</Link>
                </div>
            </div>
